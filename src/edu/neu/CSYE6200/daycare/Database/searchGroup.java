...
public class searchGroup {
 ...
 public static List<AbstractGroup> searchGroupByClassroomID(int classroomID) {
...
// int i=in.nextInt();
 try{
    ...
    stmt = conn.createStatement();
	 String sql = "SELECT * FROM grouptb where ClassroomID = ?";
    ...
    while(rs.next()){
       ...
       int classroom  = rs.getInt("ClassroomID");
       int grouprule = rs.getInt("MaxStudentNum");
       c = new Group(id,classroom,studentNum,grouprule);
